...
public class FarmermarketAppTest {
   ...
   *
   * @details This method redirects the System.in and System.out streams to simulate user input and capture the output. It calls the main method of FarmermarketApp with a valid argument and asserts the expected behavior based on the output.
   */
  @Test
  ...
  /**
   * @brief Test method to validate the object creation of FarmermarketApp.
   *
   * @details This method creates an instance of the FarmermarketApp class and asserts the successful creation of the object.
   */
  @Test
  public void testMainObject() {
    // Creating an instance of FarmermarketApp
    FarmermarketApp app = new FarmermarketApp();
   ...
   *
   * @details This method redirects the System.in and System.out streams to simulate user input and capture the output. It calls the main method of FarmermarketApp with an invalid argument and asserts the expected behavior based on the output.
   */
  @Test
